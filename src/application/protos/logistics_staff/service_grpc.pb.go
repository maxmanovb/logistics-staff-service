...
const (
	StaffService_RegisterDriver_FullMethodName      = "/StaffService/RegisterDriver"
	StaffService_LoginDriver_FullMethodName         = "/StaffService/LoginDriver"
	StaffService_ConfirmSmsCode_FullMethodName      = "/StaffService/ConfirmSmsCode"
	StaffService_GetDriverProfile_FullMethodName    = "/StaffService/GetDriverProfile"
	StaffService_UpdateDriverProfile_FullMethodName = "/StaffService/UpdateDriverProfile"
)
...
func (c *staffServiceClient) RegisterDriver(ctx context.Context, in *RegisterDriverRequest, opts ...grpc.CallOption) (*RegisterDriverResponse, error) {
	...
	err := c.cc.Invoke(ctx, StaffService_RegisterDriver_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *staffServiceClient) LoginDriver(ctx context.Context, in *LoginDriverRequest, opts ...grpc.CallOption) (*LoginDriverResponse, error) {
	...
	err := c.cc.Invoke(ctx, StaffService_LoginDriver_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *staffServiceClient) ConfirmSmsCode(ctx context.Context, in *ConfirmSmsCodeRequest, opts ...grpc.CallOption) (*ConfirmSmsCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, StaffService_ConfirmSmsCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *staffServiceClient) GetDriverProfile(ctx context.Context, in *GetDriverProfileRequest, opts ...grpc.CallOption) (*GetDriverProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, StaffService_GetDriverProfile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *staffServiceClient) UpdateDriverProfile(ctx context.Context, in *UpdateDriverProfileRequest, opts ...grpc.CallOption) (*UpdateDriverProfileResponse, error) {
	out := new(UpdateDriverProfileResponse)
	err := c.cc.Invoke(ctx, StaffService_UpdateDriverProfile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStaffServiceServer) UpdateDriverProfile(context.Context, *UpdateDriverProfileRequest) (*UpdateDriverProfileResponse, error) {
...
func _StaffService_RegisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StaffService_RegisterDriver_FullMethodName,
	}
...
func _StaffService_LoginDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StaffService_LoginDriver_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StaffService_ConfirmSmsCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StaffService_ConfirmSmsCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StaffService_GetDriverProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StaffService_GetDriverProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StaffService_UpdateDriverProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateDriverProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StaffServiceServer).UpdateDriverProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StaffService_UpdateDriverProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StaffServiceServer).UpdateDriverProfile(ctx, req.(*UpdateDriverProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StaffService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _StaffService_UpdateDriverProfile_Handler,
		},
	},
